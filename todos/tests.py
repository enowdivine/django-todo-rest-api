...
class TodosAPITestCase(APITestCase):
    def create_todo(self):
        sample_todo = {"title": "Hello", "description": "Description"}
    ...
    def authenticate(self):
        self.client.post(
            reverse("register"),
            {"username": "test", "password": "password", "email": "tugrp@example.com"},
        )
...
class TestListCreateTodos(TodosAPITestCase):
    ...
    def test_should_create_todo(self):
        ...
        self.assertEqual(response.data['descrition'], 'Description')
